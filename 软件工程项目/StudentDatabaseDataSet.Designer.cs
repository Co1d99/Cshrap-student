...
namespace 软件工程项目 {
    ...
    public partial class StudentDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string name, int age, string gender, string Course, string HomeAddress, string phone) {
...
namespace 软件工程项目.StudentDatabaseDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ([gender] = @Original_gender) AND ([Course] = @Original_Course) AND ([HomeAddress] = @Original_HomeAddress) AND ([phone] = @Original_phone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([name], [age], [gender], [Course], [HomeAddress], [p" +
                "hone]) VALUES (@name, @age, @gender, @Course, @HomeAddress, @phone);\r\nSELECT id," +
                " name, age, gender, Course, HomeAddress, phone FROM Student WHERE (id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [name] = @name, [age] = @age, [gender] = @gender, [Course] = @Course, [HomeAddress] = @HomeAddress, [phone] = @phone WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ([gender] = @Original_gender) AND ([Course] = @Original_Course) AND ([HomeAddress] = @Original_HomeAddress) AND ([phone] = @Original_phone));
SELECT id, name, age, gender, Course, HomeAddress, phone FROM Student WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::软件工程项目.Properties.Settings.Default.StudentDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, age, gender, Course, HomeAddress, phone FROM dbo.Student";
        ...
        public virtual int Delete(int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_gender, string Original_Course, string Original_HomeAddress, string Original_phone) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> age, string gender, string Course, string HomeAddress, string phone) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> age, string gender, string Course, string HomeAddress, string phone, int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_gender, string Original_Course, string Original_HomeAddress, string Original_phone, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            if ((Original_HomeAddress == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_HomeAddress));
            }
            if ((Original_phone == null)) {
                throw new global::System.ArgumentNullException("Original_phone");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> age, string gender, string Course, string HomeAddress, string phone, int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_gender, string Original_Course, string Original_HomeAddress, string Original_phone) {
            return this.Update(name, age, gender, Course, HomeAddress, phone, Original_id, Original_name, Original_age, Original_gender, Original_Course, Original_HomeAddress, Original_phone, Original_id);
        }
    }
